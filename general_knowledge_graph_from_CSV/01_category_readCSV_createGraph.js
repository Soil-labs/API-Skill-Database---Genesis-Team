...
import {findSkillSubCategory,CreateNode,CreateSkillCategory_noLightcast,CreateSkillSubCategory_WithCategory} from "../backEnd_api_func.js"
  ...
  return new Promise((resolve, reject) => {
    ...
    parser.on('readable', async function(){
      ...
      while  (record = parser.read()) {
        ...
        //             everyCategoryDict = addCategory_subCategory(key,undefined, node,everyCategoryDict)
